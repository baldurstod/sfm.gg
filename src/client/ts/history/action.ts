...
export class Action {
	...
	do(element: SfmFilmClip, command: 'delete-character', params: SfmModel): boolean;
	...
	do(element: SfmNode, command: 'delete-child', params: SfmNode): boolean;
	do(element: SfmNode, command: 'delete-children'): boolean;
